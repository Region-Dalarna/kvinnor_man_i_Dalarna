...
äldre i regioner med glesare och mindre befolkning där det inte finns större urbana
...
```{r, echo=FALSE, fig.width=5, fig.align='center', out.width="90%"}
#lista_figurer$hogutbildade_lan_kon
knitr::include_graphics(here("Diagram","utbildningsniva_jmf_lan_kon.png"))
```
...
knitr::include_graphics(here("Diagram","utbildningsniva_85_21_kon.png"))
```
