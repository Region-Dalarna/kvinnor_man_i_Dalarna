hamta_disponibel_inkomst_region_hushallstyp_alder_tid_scb <- function(
			...
			hushallstyp_klartext = "*",			 #  NA = tas inte med i uttaget,  Finns: "samtliga hushåll", "ensamstående utan barn", "ensamstående kvinnor utan barn", "ensamstående män utan barn", "ensamstående med barn 0-19 år", "ensamstående kvinnor med barn 0-19 år", "ensamstående män med barn 0-19 år", "ensamstående med kvarboende unga vuxna 20-29 år", "ensamstående kvinnor med kvarboende unga vuxna 20-29 år", "ensamstående män med kvarboende unga vuxna 20-29 år", "sammanboende utan barn", "sammanboende med barn 0-19 år", "sammanboende med kvarboende unga vuxna 20-29 år", "övriga hushåll utan barn", "övriga hushåll med barn 0-19 år"
			alder_klartext = "*",			 #  Finns: "18+ år", "18-29 år", "30-49 år", "50-64 år", "65+ år", "65-79 år", "80+ år"
			cont_klartext = "*",			 #  Finns: "Medelvärde,  tkr", "Medianvärde, tkr", "Medelvärde, procent av samtliga hushåll", "Medianvärde, procent av samtliga hushåll"
			...
			excel_filnamn = "disponibel_inkomst.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # Skapad av: frkjon den 06 maj 2024
  # Senast uppdaterad: 06 maj 2024
  #
  # url till tabellens API: https://api.scb.se/OV0104/v1/doris/sv/ssd/START/HE/HE0110/HE0110G/TabVX4bDispInkN
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/HE/HE0110/HE0110G/TabVX4bDispInkN"
