#test = diag_sysselsatta_forandring_bransch(region_vekt = hamtakommuner(lan="20",tamedriket = FALSE),spara_figur = TRUE,output_mapp_figur = "G:/skript/jon/Figurer/",diag_facet=TRUE)
