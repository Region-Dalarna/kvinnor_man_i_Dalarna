...
# Gymnasieantagning
gymnasieantagning_max_ar <- max(gymnasieantagning_df$ar)
gymnasientagning_jamlik <- gymnasieantagning_df %>% filter(ar == gymnasieantagning_max_ar,Kon == "Kvinnor") %>% filter(round(andel,0)>=40 & round(andel,0)<=60) %>% .$program %>% glue_collapse(sep = ", ", last = " och ") %>%  tolower()
antal_jamlik_gymant <- length(gymnasieantagning_df %>% filter(ar == gymnasieantagning_max_ar,Kon == "Kvinnor") %>% filter(round(andel,0)>=40 & round(andel,0)<=60) %>% .$program)
antal_program_totalt <- length(unique(gymnasieantagning_df %>% filter(ar == gymnasieantagning_max_ar) %>% .$program))

gymnasientagning_fler_man <- gymnasieantagning_df %>% filter(ar == gymnasieantagning_max_ar,Kon == "Män") %>% filter(round(andel,0)>60) %>% .$program %>% glue_collapse(sep = ", ", last = " och ") %>%  tolower()
antal_fler_man_gymant <- length(gymnasieantagning_df %>% filter(ar == gymnasieantagning_max_ar,Kon == "Män") %>% filter(round(andel,0)>60) %>% .$program)
max_man <- gymnasieantagning_df %>% filter(ar == gymnasieantagning_max_ar,Kon == "Män") %>% arrange(desc(andel)) %>% first() %>% .$program

gymnasientagning_fler_kvinnor <- gymnasieantagning_df %>% filter(ar == gymnasieantagning_max_ar,Kon == "Kvinnor") %>% filter(round(andel,0)>60) %>% .$program %>% glue_collapse(sep = ", ", last = " och ") %>%  tolower()
antal_fler_kvinnor_gymant <- length(gymnasieantagning_df %>% filter(ar == gymnasieantagning_max_ar,Kon == "Kvinnor") %>% filter(round(andel,0)>60) %>% .$program)
max_kvinna <- gymnasieantagning_df %>% filter(ar == gymnasieantagning_max_ar,Kon == "Kvinnor") %>% arrange(desc(andel)) %>% first() %>% .$program

# Genomströmning
genomstromning_max_ar <- max(genomstromning_df$ar)
