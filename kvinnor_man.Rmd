...
Jämställdhetspolitikens mål handlar om att säkerställa att kvinnor och män har samma makt att forma samhället och sina egna liv. Det innebär att synliggöra både makt, representation och resursfördelning mellan kvinnor och män, och utvecklingen följs därför med både kvalitativa och kvantitativa mått. Denna rapport ger en kvantitativ bild av nuläget i Dalarna med utgångspunkt i de sex jämställdhetspolitiska delmålen som det övergripande målet är uppdelat i. Rapporten ger även en kommunal och regional fördjupning och är ett komplement till SCB:s skrift <i>[På tal om kvinnor och män](https://www.scb.se/hitta-statistik/statistik-efter-amne/befolkning-och-levnadsforhallanden/jamstalldhet/jamstalldhetsstatistik/produktrelaterat/rapporter/lathund2024/){target="_blank"}^[Statistiska Centralbyrån, På tal om kvinnor och män.]</i>. De viktigaste trenderna och mönstren i Dalarna visar att: 
<br>
...
I samtliga av Dalarnas kommuner har männen högre medianinkomst än kvinnorna. Skillnaderna mellan kommunerna är relativt små. Medianinkomsten är `r medianinkomst_hogst`. Medianinkomsten är `r medianinkomst_lagst`.
...
Utrikes födda män har en högre sysselsättningsgrad än utrikes födda kvinnor i samtliga län. I Dalarna var sysselsättningsgraden bland utrikes födda män `r syssgrad_utrikes_man_Dalarna` procent, vilket är cirka `r syssgrad_utrikes_skillnad_Dalarna ` procentenheter mer än för utrikes födda kvinnor i Dalarna.
...
Arbetslösheten bland utrikes födda är däremot betydligt högre i samtliga av Sveriges län. I Dalarna är skillnaden i arbetslöshet mellan utrikes och inrikes födda cirka `r arblosthet_kvinnor_utrikes_inrikes_skillnad_Dalarna` procentenheter för kvinnor och cirka `r arblosthet_man_utrikes_inrikes_skillnad_Dalarna` procentenheter för män. Vidare är arbetslösheten bland gruppen utrikes födda kvinnor klart högre än i gruppen utrikes födda män i samtliga av Sveriges län, förutom i Västerbotten där den är högre för utrikes födda män.
...
Lägst arbetslöshet för inrikes födda kvinnor återfinns i `r arblosthet_inrikes_kvinna_min_kommun ` med `r arblosthet_inrikes_kvinna_min_varde` procent, `r ifelse(arblosthet_inrikes_kvinna_min_kommun != arblosthet_inrikes_man_min_kommun,glue("medan den lägsta arbetslösheten för inrikes födda män finns i {arblosthet_inrikes_man_min_kommun} med {arblosthet_inrikes_man_min_varde} procent"),glue("vilket även gäller inrikes födda män ({arblosthet_inrikes_man_min_varde} procent)"))`.

Bland utrikes födda är arbetslösheten avsevärt mycket högre för både kvinnor och män än för inrikes födda. Genomsnittet i Dalarnas län ligger på `r arblosthet_utrikes_kvinna_Dalarna` procent bland utrikes födda kvinnor och `r arblosthet_utrikes_man_Dalarna` procent bland utrikes födda män. Den högsta arbetslösheten bland utrikes födda kvinnor återfinns i `r arblosthet_utrikes_kvinna_max_kommun ` där den ligger på `r arblosthet_utrikes_kvinna_kommun_max_varde` procent. `r arblosthet_utrikes_man_max_kommun` redovisar `r ifelse(arblosthet_utrikes_man_max_kommun == arblosthet_utrikes_kvinna_max_kommun,"även","")` den högsta arbetslöshetssiffran bland utrikes födda män med `r arblosthet_utrikes_man_kommun_max_varde ` procent.
...
Arbetslösheten i Dalarna har utvecklats olika för inrikes och utrikes födda. Bland inrikes födda syns en tydlig övergripande nedgång från toppnivåerna 2010. Under pandemiåret 2020 bröts utvecklingen tillfälligt när arbetslösheten ökade för både kvinnor och män.

Bland utrikes födda kan två övergripande faser urskiljas. Mellan `r arblosa_af_forsta_ar` och 2017 ökade arbetslösheten kraftigt och nådde 2017 cirka 30 procent bland kvinnor och 37 procent bland män. Ökningen sammanföll med en period av stor flyktinginvandring till Sverige, särskilt omkring 2015–2016, men diagrammet visar inte i sig vilka faktorer som förklarar utvecklingen. Under perioden 2008–2018 var arbetslösheten genomgående högre bland utrikes födda män än bland utrikes födda kvinnor, med särskilt stora skillnader under 2015–2017.

Sedan toppnivåerna 2017 har arbetslösheten bland utrikes födda minskat kraftigt, även om nedgången inte varit helt obruten. Skillnaden mellan könen har samtidigt vänt. I den senaste redovisade perioden, `r arblosa_af_senaste_ar`, var arbetslösheten drygt `r arblosa_af_senaste_ar_kvinnor_utrikes` procent bland utrikes födda kvinnor och drygt `r arblosa_af_senaste_ar_man_utrikes` procent bland utrikes födda män. 
...
Hur långt från arbetsmarknaden en person befinner sig påverkas bland annat av hur länge personen har varit utan arbete. Långa perioder av arbetslöshet kan göra det svårare att återvända till arbetsmarknaden, exempelvis genom att kunskaper, erfarenheter och kontakter blir mindre aktuella. Här räknas personer som långtidsarbetslösa om de under minst sex månader har varit inskrivna som öppet arbetslösa eller deltagit i ett program med aktivitetsstöd.

År `r langtidsarbetsloshet_ar_min` var `r langtidsarbetsloshet_kvinnor_min` procent av kvinnorna och 3,3 procent av männen i Dalarna i åldern 25–64 år långtidsarbetslösa. Under 2010-talet varierade utvecklingen för både kvinnor och män. Bland kvinnor minskade andelen fram till 2014 och ökade därefter till 2017. Bland män var uppgången under mitten av 2010-talet tydligare, och under större delen av perioden var långtidsarbetslösheten högre bland män än bland kvinnor.

I samband med pandemin ökade långtidsarbetslösheten för båda könen och nådde sin högsta nivå 2021, då andelen var 3,7 procent bland kvinnor och 4,0 procent bland män. Därefter har långtidsarbetslösheten minskat varje år. `r text_langtidsarbetsloshet` Från och med 2023 omfattar statistiken även 65-åringar.
...
Samtidigt som fler kvinnor än män mottar transfereringar i form av exempelvis föräldrapenning går andra typer av bidrag i högre utsträckning till män som grupp. Ett sätt att få en bra bild över helheten av sociala ersättningar och bidrag är att analysera helårsekvivalenter. Helårsekvivalenter beskriver hur många personer som under ett år försörjs helt genom sociala ersättningar och bidrag. Måttet räknas i helårspersoner, vilket innebär att flera individer med delårsvisa ersättningar kan motsvara en helårsekvivalent. Syftet är att göra olika ersättningssystem och inte minst det sammantagna bidragstagandet jämförbara över tid och mellan grupper.
...
Fördelningen av dagar mellan vårdnadshavarna har jämnats ut något sedan slutet av 1990-talet då runt 85-90 procent av föräldrapenningdagarna togs ut av mammorna. Sedan dess har först en (1995), sedan två (2002) och även tre månader (2016) reserverats åt respektive vårdnadshavare (också kallade "pappamånader"). Detta har bidragit till ett jämnare uttag men utvecklingen får ändå sägas gå relativt trögt, då kvinnors andel endast har minskat till knappt `r andel_fp_kvinnor_Dalarna_senaste_ar` procent `r max(foraldrapenning_df$År)`. Svenska vårdnadshavare är således långt ifrån att ge sina barn en jämställd tillgång till sina föräldrar. Skillnaden i uttag påverkar också den disponibla inkomsten, som beskrivits under rubriken Ekonomisk jämställdhet. Skillnaden är som störst mellan sammanboende kvinnor och män när det yngsta barnet är 0–3 år [(Regeringen, 2022)](<https://www.regeringen.se/contentassets/46945970585240a4a5bfd9a0f75ecf3d/ekonomisk-jamstalldhet.pdf>){target="_blank"}.
...
Hur vårdnadshavare fördelar föräldrapenningen mellan sig är relativt olika i Dalarnas kommuner. I `r andel_fp_man_hogst_dalarna_kommun` är uttaget  mest jämställt relativt sett, där ungefär `r andel_fp_man_hogst_dalarna_kommun_varde` procent av föräldrapenningdagarna togs ut av männen. Minst jämställd är fördelningen i `r andel_fp_man_lagst_dalarna_kommun`, där motsvarande uttag är cirka `r andel_fp_man_lagst_dalarna_kommun_varde` procent.
...
Ohälsotalet^[Ohälsotalet: hur många dagar under en tolvmånadersperiod
    ...
    förhållande till antalet försäkrade i åldersgruppen 16-64 år] mäter i vilken utsträckning personer är borta från arbetet på grund av nedsatt arbetsförmåga, mätt under ett års tid. Ohälsotalet varierar över tid och var relativt högt under början av 2000-talet. Därefter syns en nedåtgående trend, om än med viss variation – bland annat sågs en tillfällig uppgång i mitten av 2010-talet, och en liknande uppgång har synts de allra senaste åren. Sett över hela perioden är dock ohälsotalet idag fortfarande klart lägre än vid 2000-talets början. Under hela tidsperioden har ohälsotalet varit högre för kvinnor än för män, även om skillnaden mellan könen har minskat något över tid.
...
Ohälsotalet för Dalarnas befolkning visar att det finns skillnader mellan länets kommuner. År `r max(ohalsotal_df$år)` är ohälsotalet `r ohalsa_hogst`, och `r ohalsa_lagst`. För att fastställa orsaken till skillnaderna mellan kommuner behövs djupare studier och analyser. Potentiella faktorer kan vara att branschstrukturen skiljer sig mellan kommunerna och att det är olika hög sjukfrånvaro i olika branscher, men även att socioekonomiska förutsättningar skiljer sig åt mellan kommunerna i Dalarna.
...
Även när det kommer till sjukpenningtalet finns det skillnader mellan Dalarnas kommuner. Talet är `r sjukp_hogst`. Sjukpenningtalet är en delmängd av ohälsotalet och därför samvarierar resultaten mellan kommunerna i stort. Talet är `r sjukp_lagst`.
